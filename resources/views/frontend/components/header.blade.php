       ...
       <div class="container">
          <div class="top-header-inner">
             <div class="header-contact text-left">
                <a href="tel:+447936331462" area-label="Phone Number">
                   ...
                   <div class="header-contact-details">
                      ...
                      <h5 class="header-contact-no">+44 79 3633 1462</h5>
                   </div>
                </a>
             </div>
             <div class="site-logo text-center">
                <h1 class="site-title">
                   <a href="{{url('/')}}">
                      <img class="lazyload" loading="lazy" src="{{ asset('frontend/assets/images/logo/travelingceylon.png') }}" alt="Traveling Ceylon Logo">
                   </a>
                </h1>
             </div>
