                            ...
                            <form class="row g-3" method="POST" action="{{ route('destinations.update') }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control" name="meta_keywords" required value="{{ $destinations->meta_keywords }}"
                                            placeholder="Meta Keywords">
                                    </div>

                                    <div class="form-row">
                                        <label for="input1" class="form-label">Meta Description</label>
                                        <textarea type="text" class="form-control" name="meta_description" placeholder="Meta Description" required>{{ $destinations->meta_description }}</textarea>
                                    </div>
