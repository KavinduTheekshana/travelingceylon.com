...
return [
    ...
    |
    */
    'turnstile_site_key' => env('APP_ENV') === 'local'
        ? '1x00000000000000000000AA' // Test key for local development
        : env('TURNSTILE_SITE_KEY', null),

    'turnstile_secret_key' => env('APP_ENV') === 'local'
        ? '1x0000000000000000000000000000000AA' // Test secret for local development
